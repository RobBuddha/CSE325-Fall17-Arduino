...
int carSpeed = 0;            // <carSpeed> determines speed of the car by duty cycles. "255*.1" = 10%, "255*.2" = 20%.
...
void loop()                        // Loop function which will be run forever.
{
  ...
  delay(5000);                    // Arbitrarily chosen number of seconds to wait once the circle is completed.
  ...
  delay(2800);
  carStop();                       // Stop the car.
  delay(5000);                    // Arbitrarily chosen number of seconds to wait once circle is complete (10 seconds).
}
